...
## Estrutura
	...
	- `scripts/agents_git.md` → Instruções e fluxos de trabalho para Git, GitHub e GitLab  
	- `scripts/agents_latex.md` → Instruções e padrões para documentos LaTeX  
	- `scripts/agents_python.md` → Instruções para Python, PEP8, Sphinx e formatação de código
